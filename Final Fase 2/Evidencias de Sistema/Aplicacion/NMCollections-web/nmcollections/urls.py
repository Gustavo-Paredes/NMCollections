...
from apps.subastas import views as subastas_api_views
...
urlpatterns = [
    ...
    # API de subastas para frontend JS
    path('api/v1/subastas/<int:subasta_id>/pujas/', subastas_api_views.api_obtener_pujas, name='api_v1_pujas'),
    path('api/v1/subastas/<int:subasta_id>/mensajes/', subastas_api_views.api_obtener_mensajes, name='api_v1_mensajes'),
    path('api/v1/subastas/<int:subasta_id>/enviar-mensaje/', subastas_api_views.api_enviar_mensaje, name='api_v1_enviar_mensaje'),
